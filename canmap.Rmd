...
## Downloading and converting the map files for the first time
 ...
 Get data from Statistics Canada: http://www12.statcan.gc.ca/census-recensement/2011/geo/bound-limit/bound-limit-2011-eng.cfm. It is a zipped archive containin an ArcGIS .shp file for Census divisions and cartographic boundaries. Expand the zip file into a directory in your working folder named 'data'. Then import the shapefile into R as SpatialPolygon Dataframe.
